...
<head>
    ...
    <link href="CSSClasses/Home.css" rel="stylesheet" >
...
<body>
    ...
    <div class="container-fluid p-0">
        <div class="row no-gutters">
            <div class="col-md-6">
                <img src="pictures/Iglesia.jpeg" alt="Imagen 1" class="img-fluid img-custom img-left">
            </div>
        ...
        <div class="row no-gutters">
            <div class="col-md-6 order-md-2">
                <img src="pictures/PuertoAntes.jpg" alt="Imagen 2" class="img-fluid img-custom img-right">
            </div>
        ...
        <div class="row no-gutters">
            <div class="col-md-6">
                <img src="pictures/ClubCentro.jpeg" alt="Imagen 3" class="img-fluid img-custom img-left">
            </div>
            <div class="col-md-6 d-flex align-items-center bg-white">
                <div class="p-4 text-container">
        ...
        <div class="row no-gutters">
            <div class="col-md-6 order-md-2">
                <img src="pictures/4600antiguo.jpg" class="img-fluid img-custom img-right">
    ...
    <footer class="footer">
        <div class="container text-center">
            <p>Universidad de Costa Rica - Simposio de Informática Empresarial</p>
        </div>
    </footer>
